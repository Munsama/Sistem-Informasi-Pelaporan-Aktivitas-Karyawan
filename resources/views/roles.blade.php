...
<p class="mb-4">In this page you can add, edit, and delete role data that will be used to create user accounts.</p>

<!-- DataTales Example -->
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary"> DataTables of Role</h6>
  </div>
  <div class="card-body">
     <div align="right">
      <button type="button" name="create_role" id="create_role" class="btn btn-success btn-sm">Add Role</button>
     </div>
     <br />
   <div class="table-responsive">
    <table class="table table-bordered table-hover" id="role_table" width="100%">
           <thead>
            <tr>
                <th> No </th>
                <th> Role Name</th>
...
$(document).ready(function(){
 ...
 $(document).on('click', '.edit', function(){
  ...
  $('#form_result').html('');
  $.ajax({
   url:"crud_role/"+id+"/edit",
   dataType:"json",
   success:function(html){
    $('#name').val(html.data.role_name);
