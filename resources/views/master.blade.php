...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <img src="{{ asset('assets/template/img/Cemindo3.png')}}" class="img-responsive"  style="height:80px; width:90%;">
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('post')}}">Positions</a>
            <a class="collapse-item" href="{{route('dept')}}">Departments</a>
            <a class="collapse-item" href="{{route('lead')}}">Leaders</a>
            <a class="collapse-item" href="{{route('role')}}">Roles</a>
            <a class="collapse-item" href="{{route('class')}}">Classifications</a>
            <a class="collapse-item" href="{{route('equip')}}">Equipment</a>
            <a class="collapse-item" href="{{route('effi')}}">Efficiencies</a>
            <a class="collapse-item" href="{{route('comp')}}">Compentencies</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"> Subordinate Reports</h6>
            <a class="collapse-item" href="{{route('actr')}}">Activities</a>
            <a class="collapse-item" href="{{route('rslt')}}">Results</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="{{route('ep')}}">
